...
public final class ExoPlayerView extends FrameLayout implements AdViewProvider {
    ...
    public ExoPlayerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        layout.addView(subtitleLayout, 1, layoutParams);
    ...
    public void setSubtitleStyle(SubtitleStyle style) {
        ...
        subtitleLayout.setApplyEmbeddedFontSizes(false);
        subtitleLayout.setApplyEmbeddedStyles(false);
        subtitleLayout.setStyle(new CaptionStyleCompat(Color.parseColor(style.getFontColor()),Color.parseColor(style.getBackgroundColor()) , Color.TRANSPARENT,
